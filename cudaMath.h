...
#ifndef __CUDA_UTIL_MATH_H
#define __CUDA_UTIL_MATH_H
 ...
 * floor(a/b)
 */
inline __device__ __host__ int iDivDown(int a, int b) { return a / b; }

/**
 * Align a to nearest higher multiple of b
 */
inline __device__ __host__ int iAlignUp(int a, int b) { return ((a % b) != 0) ? (a - a % b + b) : a; }

/*
 * Align a to nearest lower multiple of b
 */
inline __device__ __host__ int iAlignDown(int a, int b) { return a - a % b; }
...
inline __device__ __host__ int max(int a, int b)
{
  return a > b ? a : b;
}

inline __device__ __host__ int min(int a, int b)
{
  return a < b ? a : b;
}

inline __device__ __host__ float rsqrtf(float x)
{
    return 1.0f / sqrtf(x);
}
#endif
